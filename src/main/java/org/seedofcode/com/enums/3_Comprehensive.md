## Comprehensive Day Enum Example

Let's create a comprehensive example using the Day enum that incorporates fields, methods, and constructors. 
In this example, we'll also include some additional functionalities like checking if a given day is a weekend and printing a friendly message for each day.
